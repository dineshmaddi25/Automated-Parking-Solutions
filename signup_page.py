...
class SignUp:
    def __init__(self, root):
        ...
        self.bg_img = ImageTk.PhotoImage(file="E:/GUI USING TKINTER/image/website_keyvisual_parking.jpg")
        ...
        self.signup = Button(frame,text="Sign Up",command=self.signup_func,font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="green2",fg="white").place(x=10,y=470,width=250)
        self.signup = Button(frame,text="Back to main page",font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="green2",fg="white").place(x=240,y=470,width=250)
